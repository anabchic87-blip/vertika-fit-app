...
const frasesVertika=["La disciplina pesa gramos. Los resultados pesan kilos.","Pequeñas acciones repetidas crean grandes cambios.","No necesitas motivación todos los días. Necesitas dirección.","Hoy no se negocia contigo: hoy se avanza.","Move. Train. Progress.","Tu mejor versión también se entrena.","Un día más cumpliendo es un día menos dudando."];
...
function guardarTransformacion() {
  ...
  // Firebase desactivado en versión local.
